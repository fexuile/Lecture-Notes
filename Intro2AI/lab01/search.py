...
def depthFirstSearch(problem):
    ...
    while not Q.isEmpty():
        ...
        for next in problem.getSuccessors(state):
            state2 = next[0]
            direction =  next[1]
            Q.push((state2,action+[direction]))
...
def uniformCostSearch(problem):
    ...
    while not q.isEmpty():
        ...
        for next in problem.getSuccessors(state):
            ...
            direction = next[1]
            w = next[2]
            q.push((state2,action+[direction],w+val),w+val)
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while not q.isEmpty():
        ...
        for next in problem.getSuccessors(state):
            ...
            direction = next[1]
            w = next[2]
            q.push((state2,action+[direction],w+val),w+val+heuristic(state2,problem))
