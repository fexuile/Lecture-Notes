...
wordsig ALUAND	'A_AND'		     # ALU should add its arguments
...
wordsig M_valE  '(word_t)ex_mem_curr->vale'      # ALU E value
...
word aluA = [
	E_icode == IIADDQ && E_valC == 1 && M_icode == IOPQ && M_ifun == ALUAND && M_valE <= 0 : 0;
